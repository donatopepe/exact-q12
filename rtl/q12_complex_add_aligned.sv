module q12_complex_add_aligned #(
    parameter int W = 32,
    parameter int EW = 8,
    ...
    q12_add_aligned #(.W(W), .EW(EW), .OUT_W(OUT_W), .MAX_SHIFT(MAX_SHIFT)) real_add (
    ...
    q12_add_aligned #(.W(W), .EW(EW), .OUT_W(OUT_W), .MAX_SHIFT(MAX_SHIFT)) imag_add (
